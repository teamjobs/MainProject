...
<body>
	...
	<div class="alert alert-danger" id="checkFail" style="color: font-style: color: blank;">
		<strong>Fail!</strong>  <br/> 등록중에 에러가 발생했습니다. <br/>다시 시도해 주십세요!
	</div>
	</c:if>
	<div
		...
		<div class="w3-display-middle" align="center">
			...
			<button type="button" class="btn btn-default"
					...
					onclick="location.href='/work/main'">홈으로</button>
