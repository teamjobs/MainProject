...
<body>	
	...
	<div class="w3-progress-container w3-round-xlarge w3-small">
		<div class="w3-progressbar w3-round-xlarge w3-gray" style="width: 90%">
			<div class="w3-center w3-text-white">90%</div>
		</div>
	</div>
	<p>승진 기회 및 가능성</p>
	<div class="w3-progress-container w3-round-xlarge w3-small">
		<div class="w3-progressbar w3-round-xlarge w3-gray" style="width: 80%">
			<div class="w3-center w3-text-white">80%</div>
		</div>
	</div>
	<p>업무와 삶의 균형</p>
	<div class="w3-progress-container w3-round-xlarge w3-small">
		<div class="w3-progressbar w3-round-xlarge w3-gray" style="width: 75%">
	...
	<div class="w3-progress-container w3-round-xlarge w3-small">
		<div class="w3-progressbar w3-round-xlarge w3-gray" style="width: 50%">
	...
	<div class="w3-progress-container w3-round-xlarge w3-small">
	  ...
	  <div class="w3-twothird w3-container">
	   		<div class="w3-container w3-section w3-border-left w3-pale-yellow w3-border-yellow">
			   <b>한줄평</b> <br/>
			</div>
