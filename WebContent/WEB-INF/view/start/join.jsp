...
<body>
	...
	<div class="container">
		...
		<form action="/member/joinOK" method="post">
			<div class="form-group">
				<label for="usr">ID:</label>    (5자 이상 입력해주세요) <input type="text" class="form-control"
					name="id" required="required" id="id"> <br />
				<button type="button" class="btn btn-info" id="check" disabled="disabled">아이디
					중복확인</button>
			</div>
			...
			<div class="container"  align="left" >
			  ...
			  <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
			  	id="confirm" data-target="#myModal" style="padding: 5px 20px;" >이메일 인증</button>
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        ...
			        <div class="modal-footer">
			         <button type="button" class="btn btn-default" data-dismiss="modal" id="mailcheck">인증완료</button>
			        </div>
			      </div>
	...
	<script>
		...
		$("#confirm").click(function() {
			$.ajax({
				"method" : "get",
				"url" : "/member/mail?email=" + $("#email").val() +"&id=" +$("#id").val()
			}).done(function(rst) {
